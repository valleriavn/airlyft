...
<div class="main-content">
    ...
    <nav class="navbar navbar-expand-lg bg-white shadow-sm mb-4 rounded">
        <div class="container-fluid">
            <button class="btn btn-link d-lg-none" type="button" data-bs-toggle="collapse" data-bs-target="#sidebarMenu">
                <i class="fas fa-bars fa-lg"></i>
            </button>
            
            <span class="navbar-text ms-2">
                Welcome back, <strong><?= htmlspecialchars($admin_name) ?></strong>
            </span>
        ...
        <div class="col-lg-8">
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body">
                    <?php
                    $recent = $conn->query("
                        SELECT b.booking_id, u.name, p.place_name AS place, s.departure_time, b.booking_status
                        FROM Booking b
