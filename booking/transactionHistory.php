                ...
                <ul class="navbar-nav ms-auto align-items-center gap-2 gap-lg-4">
                    ...
                    <li class="nav-item dropdown user-dropdown ms-lg-3">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item active" href="transactionHistory.php"><i class='bx bx-history'></i> Transaction History</a></li>
                            <li>
    ...
    <main class="container py-5">
        ...
        <div class="row mb-5">
            ...
            <div class="col-md-4">
                <div class="stats-card text-center">
                    <h3><?= date('Y') ?></h3>
                    <p>Member Since <?= date('Y', strtotime($_SESSION['created_at'] ?? 'now')) ?></p>
                </div>
            </div>
        </div>
            ...
            <div class="col-12">
                ...
                <?php if (empty($transactions)): ?>
                    <div class="alert alert-info text-center py-5">
                        ...
                        <a href="destinations.php" class="btn btn-primary mt-3">Book Now</a>
                    </div>
                <?php else: ?>
                        ...
                        <div class="transaction-card <?= $status_class ?>">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <small class="transaction-details"><?= htmlspecialchars($transaction['aircraft_type']) ?></small>
                                </div>
                                <div class="col-md-3">
                                    <div class="transaction-details">
                                ...
                                <div class="col-md-3 text-end">
                                    ...
                                    <?php if ($transaction['payment_status']): ?>
                                        <span class="status-badge badge-paid mt-2">
                                            <?= $transaction['payment_status'] ?> (<?= $transaction['payment_method'] ?>)
                                        </span>
                                    <?php endif; ?>
                                    <br>
                                    <small class="transaction-details"><?= date('M d, Y', strtotime($transaction['created_at'])) ?></small>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
