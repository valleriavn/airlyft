            ...
            <form method="get" class="row g-3">
                <div class="col-md-5">
                    ...
                    <select name="place_id" class="form-select">
                        ...
                        <?php while($p = $destinations->fetch_assoc()): ?>
                ...
                <div class="col-md-5">
                    ...
                    <select name="lift_id" class="form-select">
                        ...
                        <?php while($a = $aircrafts->fetch_assoc()): ?>
                        ...
                        <?php while ($row = $schedules->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <small><?= date('h:i A', strtotime($row['arrival_time'])) ?></small>
                                </td>
                                <td>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addScheduleLabel">Create New Flight Schedule</h5>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <select name="lift_id" class="form-select" required>
                                    ...
                                    <?php 
                                    $aircrafts->data_seek(0); // reset pointer
