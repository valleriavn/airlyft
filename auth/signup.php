...
<<<<<<< HEAD
                            const errorMessages = {
                                ...
                                'short_lastname': 'Last name must be at least 2 characters.',
                                'invalid_email': 'Please enter a valid email address.',
                                'invalid_gmail': 'Please use a Gmail address.',
                                'short_password': 'Password must be at least 8 characters with uppercase, lowercase, number, and special character.',
                                'password_no_lowercase': 'Password must be at least 8 characters with uppercase, lowercase, number, and special character.',
                                'password_no_uppercase': 'Password must be at least 8 characters with uppercase, lowercase, number, and special character.',
                                'password_no_number': 'Password must be at least 8 characters with uppercase, lowercase, number, and special character.',
                                'password_no_special': 'Password must be at least 8 characters with uppercase, lowercase, number, and special character.',
