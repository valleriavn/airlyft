    ...
    <section class="hero" id="home">
        ...
        <div class="container">
            <div class="hero-content text-center">
                ...
                <a href="#destinations" class="btn-green">Explore Exclusive Destinations</a>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                ...
                $destinations = [
                    ...
                    [
                        "name" => "Huma Island Resort",
                        "image" => "huma.png",
                        "description" => "Overwater Villas in Coron",
                        "link" => "https://huma-island-resort-spa.coronhotelsonline.com/en/"
                    ],
                    [
                    ...
                    [
                        "name" => "Farm San Benito",
                        "image" => "thefarmbenito.png",
                ...
                ?>
                    <div class="col-lg-4 col-md-6">
                        <a href="<?= $destination['link'] ?>" target="_blank" rel="noopener noreferrer" class="destination-card text-decoration-none">
                            <div class="card-image">
                                <img src="assets/img/<?= $destination['image'] ?>" alt="<?= $destination['name'] ?>" loading="lazy">
                                <div class="overlay">
    ...
    <section class="section-padding bg-gradient-fleet" id="fleet">
        <div class="container">
            ...
            <div class="text-center mt-5 pt-4">
                <a href="auth/login.php" class="btn-green">Book Your Private Flight</a>
            </div>
        </div>
    </section>
